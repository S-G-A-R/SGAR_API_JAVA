...
@Data
public class OperadorGuardarDto {
    ...
    @NotNull(message = "El documento de licencia es requerido")
    private byte[] licenciaDoc;

    @NotNull(message = "El documento de antecedentes es requerido")
    private byte[] antecedentesDoc;

    @NotNull(message = "El documento de solvencia es requerido")
